// contracts/abis.ts - REEMPLAZAR TODO EL CONTENIDO
// ✅ ABI COMPLETA DEL FACTORY CONTRACT (basada en tus archivos JSON)
...
// ✅ ABI COMPLETA DEL PROFILE CONTRACT (basada en tus archivos JSON)
